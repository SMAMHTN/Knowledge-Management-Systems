...
ALTER TABLE `core_history` DISABLE KEYS;
ALTER TABLE `core_history` ENABLE KEYS;
UNLOCK TABLES;
...
ALTER TABLE `core_setting` DISABLE KEYS;
ALTER TABLE `core_setting` ENABLE KEYS;
UNLOCK TABLES;
...
ALTER TABLE `core_theme` DISABLE KEYS;
ALTER TABLE `core_theme` ENABLE KEYS;
UNLOCK TABLES;
...
ALTER TABLE `core_user` DISABLE KEYS;
ALTER TABLE `core_user` ENABLE KEYS;
UNLOCK TABLES;
