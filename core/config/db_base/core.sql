...
CREATE TABLE `core_history` (
  ...
  CONSTRAINT `core_history_FK` FOREIGN KEY (`UserID`) REFERENCES `core_user` (`UserID`) ON UPDATE CASCADE
...
CREATE TABLE `core_role` (
  ...
  CONSTRAINT `core_role_FK` FOREIGN KEY (`RoleParentID`) REFERENCES `core_role` (`RoleID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `core_setting` (
  ...
  CONSTRAINT `core_setting_FK` FOREIGN KEY (`AppthemeID`) REFERENCES `core_theme` (`AppthemeID`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_user` (
  ...
  CONSTRAINT `core_user_FK` FOREIGN KEY (`RoleID`) REFERENCES `core_role` (`RoleID`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
